...
if (isset($_POST['submit'])) {
    ...
    $from = "info.krmv@gmail.com"; // Email con el dominio del Hosting para evitar SPAM
    $fromName = "RPF-WEB"; // Nombre que saldrá en el email recibido
    $to = "kalitha_mc@hotmail.com"; // Dirección donde se enviará el formulario
    ...
    $fullMessage .= "Empresa: " . $_POST['validarEmpresa'] . "\r\n";
    $fullMessage .= "Resumen: " . $_POST['validarResumen'] . "\r\n";
    $fullMessage .= "Enlaces: " . $_POST['validarEnlaces'] . "\r\n";
    $fullMessage .= "Paquetes: " . $_POST['validarPaquetes'] . "\r\n";
    $fullMessage .= "Marca: " . $_POST['validarMarca'] . "\r\n";
    $fullMessage .= "Kalitha: " . $_POST['validarKalitha'] . "\r\n";
    $fullMessage .= "\r\n";
    $fullMessage .= "Saludos!\r\n";
